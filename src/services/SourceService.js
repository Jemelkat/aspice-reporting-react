...
export default class SourceService {
	static getScoreRanges(sourceId) {
		return axiosInstance.get(`source/${sourceId}/ranges`);
	}

	static updateScoreRanges(sourceId, scoreRanges) {
		return axiosInstance.post(`source/${sourceId}/ranges`, scoreRanges);
	}
